...
from speller.session.flashing_strategy import IFlashingStrategy, SquareRowColumnFlashingStrategy
...
def get_speller_container(stub: bool = True) -> Container:
    ...
    builder.singleton(IFlashingStrategy, SquareRowColumnFlashingStrategy)
